/********************************************************************************
** Form generated from reading UI file 'hysteresischartsettingswindow.ui'
**
...
public:
    ...
    void setupUi(QWidget *HysteresisChartSettingsWindow)
    {
        ...
        HysteresisChartSettingsWindow->resize(183, 905);
        ...
        gridLayout_2->addWidget(pushButton_trigger, 6, 0, 1, 1);
        ...
        gridLayout_2->addWidget(dial_x, 2, 0, 1, 1);
