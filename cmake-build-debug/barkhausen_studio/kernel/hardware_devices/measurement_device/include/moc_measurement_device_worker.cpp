...
QT_MOC_LITERAL(5, 75, 6), // "opened"
QT_MOC_LITERAL(6, 82, 4), // "open"
QT_MOC_LITERAL(7, 87, 28), // "continuous_acquisition_start"
QT_MOC_LITERAL(8, 116, 27), // "continuous_acquisition_stop"
QT_MOC_LITERAL(9, 144, 11), // "single_shot"
QT_MOC_LITERAL(10, 156, 11), // "device_name"
QT_MOC_LITERAL(11, 168, 15), // "set_ref_voltage"
QT_MOC_LITERAL(12, 184, 3) // "val"

    },
    "MeasurementDeviceWorker\0new_data_available\0"
    "\0const unsigned char*\0read_next\0opened\0"
    "open\0continuous_acquisition_start\0"
    "continuous_acquisition_stop\0single_shot\0"
    "device_name\0set_ref_voltage\0val"
};
...
void MeasurementDeviceWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->set_ref_voltage((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (MeasurementDeviceWorker::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MeasurementDeviceWorker::opened)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void MeasurementDeviceWorker::opened()
{
