...
public:
    ...
    QLabel *label_port_2;
    QSlider *horizontalSlider_voltage_source;
    ...
    void setupUi(QWidget *MeasDeviceSettings)
    {
        ...
        horizontalSlider_voltage_source = new QSlider(frame_2);
        horizontalSlider_voltage_source->setObjectName(QString::fromUtf8("horizontalSlider_voltage_source"));
        sizePolicy2.setHeightForWidth(horizontalSlider_voltage_source->sizePolicy().hasHeightForWidth());
        horizontalSlider_voltage_source->setSizePolicy(sizePolicy2);
        horizontalSlider_voltage_source->setMinimum(0);
        horizontalSlider_voltage_source->setMaximum(10);
        horizontalSlider_voltage_source->setSingleStep(1);
        horizontalSlider_voltage_source->setPageStep(10);
        horizontalSlider_voltage_source->setValue(0);
        horizontalSlider_voltage_source->setOrientation(Qt::Horizontal);

        gridLayout_2->addWidget(horizontalSlider_voltage_source, 6, 0, 1, 2);
    ...
    void retranslateUi(QWidget *MeasDeviceSettings)
    {
        ...
        label_sample_rate_3->setText(QApplication::translate("MeasDeviceSettings", "Reference voltage ", nullptr));
        ...
        comboBox_port_source->setItemText(0, QApplication::translate("MeasDeviceSettings", "101", nullptr));
        comboBox_port_source->setItemText(1, QApplication::translate("MeasDeviceSettings", "102", nullptr));
        comboBox_port_source->setItemText(2, QApplication::translate("MeasDeviceSettings", "103", nullptr));
        comboBox_port_source->setItemText(3, QApplication::translate("MeasDeviceSettings", "104", nullptr));

        label_points_per_chunk_vals_source->setText(QApplication::translate("MeasDeviceSettings", "Points per chunk", nullptr));
    } // retranslateUi
