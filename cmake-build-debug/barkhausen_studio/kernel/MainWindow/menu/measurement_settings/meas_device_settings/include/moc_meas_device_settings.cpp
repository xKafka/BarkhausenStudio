/****************************************************************************
** Meta object code from reading C++ file 'meas_device.h'
**
...
#include "../../../../../../../../barkhausen_studio/kernel/MainWindow/menu/measurement_settings/meas_device_settings/include/meas_device_settings.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'meas_device.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(6, 76, 15), // "process_command"
QT_MOC_LITERAL(7, 92, 13), // "ParsedCommand"
QT_MOC_LITERAL(8, 106, 3) // "cmd"
...
void MeasDeviceSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->process_command((*reinterpret_cast< const ParsedCommand(*)>(_a[1]))); break;
        default: ;
        }
