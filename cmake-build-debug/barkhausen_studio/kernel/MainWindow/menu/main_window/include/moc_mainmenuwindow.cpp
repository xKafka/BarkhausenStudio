...
#include "../../../../../../../barkhausen_studio/kernel/MainWindow/menu/main_window/include/mainmenuwindow.h"
...
QT_MOC_LITERAL(1, 15, 7), // "command"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 20), // "std::vector<uint8_t>"
QT_MOC_LITERAL(4, 45, 12), // "back_clicked"
QT_MOC_LITERAL(5, 58, 15), // "process_command"
QT_MOC_LITERAL(6, 74, 13), // "ParsedCommand"
QT_MOC_LITERAL(7, 88, 3), // "cmd"
QT_MOC_LITERAL(8, 92, 12) // "emit_command"

    },
    "MainMenuWindow\0command\0\0std::vector<uint8_t>\0"
    "back_clicked\0process_command\0ParsedCommand\0"
    "cmd\0emit_command"
};
...
void MainMenuWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MainMenuWindow::*)(const std::vector<uint8_t> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenuWindow::command)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainMenuWindow::command(const std::vector<uint8_t> & _t1)
{
