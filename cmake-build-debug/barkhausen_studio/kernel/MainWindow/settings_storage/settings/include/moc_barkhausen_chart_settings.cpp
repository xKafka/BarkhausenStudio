...
#include "../../../../../../../barkhausen_studio/kernel/MainWindow/settings_storage/settings/include/barkhausen_chart_settings.h"
...
QT_MOC_LITERAL(3, 33, 17) // "BarkhausenSetting"

    },
    "BarkhausenChartSettings\0changed\0\0"
    "BarkhausenSetting"
};
...
void BarkhausenChartSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< const BarkhausenSetting(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BarkhausenChartSettings::*)(const BarkhausenSetting );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BarkhausenChartSettings::changed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BarkhausenChartSettings::changed(const BarkhausenSetting _t1)
{
