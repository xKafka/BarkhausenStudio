...
#include "../../../../../../barkhausen_studio/kernel/core/core/include/core.h"
...
QT_MOC_LITERAL(1, 5, 21), // "new_ui_data_available"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 10), // "DataBuffer"
QT_MOC_LITERAL(4, 39, 19), // "start_meas_sequence"
QT_MOC_LITERAL(5, 59, 18), // "stop_meas_sequence"
QT_MOC_LITERAL(6, 78, 20) // "single_meas_sequence"

    },
    "Core\0new_ui_data_available\0\0DataBuffer\0"
...
void Core::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->new_ui_data_available((*reinterpret_cast< const DataBuffer(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Core::*)(const DataBuffer & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Core::new_ui_data_available)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Core::new_ui_data_available(const DataBuffer & _t1)
{
