...
#include "../../../../../../barkhausen_studio/kernel/core/device_finder/include/device_finder.h"
...
QT_MOC_LITERAL(1, 13, 12), // "usb_reloaded"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 17) // "new_dev_connected"

    },
    "DeviceFinder\0usb_reloaded\0\0new_dev_connected"
};
...
void DeviceFinder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->usb_reloaded(); break;
        case 1: _t->new_dev_connected((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeviceFinder::usb_reloaded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DeviceFinder::usb_reloaded()
{
